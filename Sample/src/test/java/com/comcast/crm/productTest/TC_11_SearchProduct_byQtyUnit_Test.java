...
public class TC_11_SearchProduct_byQtyUnit_Test extends BaseClass 
{
	@Test(groups = "smokeTest")  
	public void createProduct() throws Throwable
	{
			String prodName = eUtil.getExcelData("product", 1, 2)+JavaUtility.getRamdonData();
			/* navigate to PRODUCT */
	...
	public void searchProductByQty() throws Throwable
	{
			String prodName = eUtil.getExcelData("product", 1, 2)+JavaUtility.getRamdonData();
			String searchby = eUtil.getExcelData("product", 1, 3);
			/* navigate to PRODUCT */
			HomePage homepage=new HomePage(driver);
			homepage.clickOnProductLink();
          ...
          /* create new product */
			...
			/* verification */
			ProductInformationPage infopage=new ProductInformationPage(driver);
			String title = driver.findElement(By.xpath("//td[@id='mouseArea_Qty/Unit']")).getText();
			String actualpro = infopage.product(); 
			Assert.assertTrue(actualpro.contains(prodName));
